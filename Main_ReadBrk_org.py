...
select_chname = ['Dist_0','Dist_1','Dist_2','Dist_3']
plt_stats_bar(df_spec,'GroupSpec','RoadInfo',x=select_chname,st='AMPM',num='WHC',numunit='°C')
plt_stats_bar(df_spec,'GroupSpec','RoadInfo',x=select_chname,st='GroupSpec',num='Per_Dist_mean',numunit='%')

plt_group_multi(df_spec,['RoadInfo', 'GroupSpec', 'day'],'WHC','Dist_mean',text='AMPM')
plt_group_multi(df_spec,['RoadInfo', 'GroupSpec', 'day'],'perDist','Dist_mean',text='AMPM')
# plt_group_multi(df_final,['RoadInfo','GroupSpec'],'perDist','Dist_mean',text='day')
plt_group_multi(df_final,['RoadInfo','GroupSpec'],'perDist','Dist_mean',text='WHC')
plt_group_multi(df_final,['WaterDepth', 'RoadInfo'],'perDist','Dist_mean',text='GroupSpec')
plt_group_multi(df_final,['WaterDepth', 'RoadInfo','AMPM'],'WHC','Dist_mean',text='GroupSpec')
plt_group_multi(df_spec,['WaterDepth', 'RoadInfo'],'WHC','Dist_mean',text='GroupSpec')
# plt_stats_bar(df_final,'RoadInfo','WaterDepth',x=select_chname,st='GroupSpec',num='WHC',numunit='°C')

## Spec PI (AM/PM 구분)
df_AM = df_spec[df_spec['AMPM']!='AM']
df_PM = df_spec[df_spec['AMPM']!='PM']
plt_group_multi(df_AM,['RoadInfo', 'GroupSpec'],'WHC','Per_Dist_mean',text='day')
...
# ## Slip 경향성
plt_group_multi(df_srtt,['RoadInfo', 'TestSet'],'WHC','Dist_mean',text='AMPM')
plt_group_multi(df_srtt,['WaterDepth', 'RoadInfo'],'WHC','Dist_mean',text='TestSet')
